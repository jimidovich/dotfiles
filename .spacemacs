...
you should place your code here."
  (setq ycmd-server-command '("python" "/home/yiju/.vim/bundle/YouCompleteMe/third_party/ycmd/ycmd/")
        ycmd-global-config "/home/yiju/.vim/data/.ycm_extra_conf.py")
  (setq ycmd-force-semantic-completion t)
  ;; (setq ycmd-extra-conf-whitelist '("~/.vim/data/*"))
  )
